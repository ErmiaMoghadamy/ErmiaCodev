    ...
    return (
        <>
            <section className="max-w-6xl container mx-auto px-2 py-6">
                <HeroBanner badge="Personal" title="Ermia Codev (Ermia Moghadamy)" linkTxt="Read more details about My Resume" caption="I'm Ermia Moghadamy, Software Engineer, Data Scientist & SysAdmin. Official TVET Instructor" />
                <div className="py-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <HeroMiniPost link="/Courses" linkTxt="See Courses" thumbnail="/assets/Courses.png" title="Courses: Software Development tutorials" />
